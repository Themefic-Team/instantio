    ...
    function ins_over_checkout_billing_fields($fields) {
        ...
        foreach( $ins_all_checkout_fields as $fieldskey => $ins_field){
            ...
            if($field_origin == 'billing_first_name'){
                ...
                $fields['billing']['billing_first_name']['priority']    = '1'. $fieldskey;
                ...
                $fields['billing']['billing_last_name']['priority']     = '1'. $fieldskey;
                ...
                $fields['billing']['billing_company']['priority']       = '1'. $fieldskey;
                ...
                $fields['billing']['billing_email']['priority']         = '1'. $fieldskey;
                ...
                $fields['billing']['billing_country']['priority']       = '1'. $fieldskey;
                ...
                $fields['billing']['billing_address_1']['priority']     = '1'. $fieldskey;
                ...
                $fields['billing']['billing_address_2']['priority']     = '1'. $fieldskey;
                ...
                $fields['billing']['billing_city']['priority']          = '1'. $fieldskey;
                ...
                $fields['billing']['billing_state']['priority']         = '1'. $fieldskey;
                ...
                $fields['billing']['billing_postcode']['priority']      = '1'. $fieldskey;
                ...
                $fields['billing']['billing_phone']['priority']          = '1'. $fieldskey;
    ...
    function ins_over_checkout_shipping_fields($fields) {
        ...
        foreach( $ins_all_checkout_fields as $fieldskey => $ins_field){
            ...
            if($field_origin == 'shipping_first_name'){
                ...
                $fields['shipping']['shipping_first_name']['priority']      = '1'. $fieldskey;
                ...
                $fields['shipping']['shipping_last_name']['priority']       = '1'. $fieldskey;
                ...
                $fields['shipping']['shipping_company']['priority']         = '1'. $fieldskey;
                ...
                $fields['shipping']['shipping_country']['priority']         = '1'. $fieldskey;
                ...
                $fields['shipping']['shipping_address_1']['priority']       = '1'. $fieldskey;
                ...
                $fields['shipping']['shipping_address_2']['priority']       = '1'. $fieldskey;
                ...
                $fields['shipping']['shipping_city']['priority']            = '1'. $fieldskey;
                ...
                $fields['shipping']['shipping_state']['priority']           = '1'. $fieldskey;
                ...
                $fields['shipping']['shipping_postcode']['priority']        = '1'. $fieldskey;
