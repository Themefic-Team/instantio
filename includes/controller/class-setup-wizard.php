...
if ( ! class_exists( 'TF_Setup_Wizard' ) ) {
	class TF_Setup_Wizard {
                ...
                <section class="tf-setup-step-layout">
                    ...
                    <div class="tf-setup-form-item bg">
                        ...
                        <ul class="tf-select-mode">
                            <li>
                                <input type="radio" name="ins-layout-mode" value="light" <?php echo empty($ins_layout_mode) || ( 'light' === $ins_layout_mode) ? esc_attr( 'checked' ) : ''; ?> />
                        ...
                        if($is_Pro_active === true) { ?>
                            ...
                            <div class="tf-setup-form-item bg">  
                                ...
                                <ul class="tf-select-progressbar">
                                    <li>
                                        <input type="radio" name="ins-layout-progressbar" value="1" <?php echo empty($ins_layout_progressbar) || ( '1' === $ins_layout_progressbar) ? esc_attr( 'checked' ) : ''; ?> />
		...
		private function setup_step_two() {
            ...
            $toggle_position = !empty(insopt( 'toggle-position' )) ? insopt( 'toggle-position' ) : '';
                    ...
                    <div class="tf-setup-form-item middle">
                        ...
                        <div class="tf-setup-form-item-input">
                            <select name="ins-layout" id="tf-wishlist-page">
								...
								<option value="cart" selected="<?php echo empty($ins_layout) || ( 'cart' === $ins_layout) ? esc_attr( 'selected' ) : ''; ?>">
                                ...
                                if($is_Pro_active === true) { ?>
                                    <option value="cartandcheckout" selected="<?php echo empty($ins_layout) || ( 'cartandcheckout' === $ins_layout) ? esc_attr( 'selected' ) : ''; ?>">
                    ...
                    <div class="tf-setup-form-item middle">
                        ...
                        <div class="tf-setup-form-item-input"> 
                            <select name="toggle-position" id="toggle-position">
                                ...
                                <option value="right-top" selected="<?php echo empty($toggle_position) || ( 'right-top' === $toggle_position) ? esc_attr( 'selected' ) : ''; ?>">
                                    <?php _e( 'Right Top', 'instantio' ) ?>
                                </option>

                                <option value="right-middle" selected="<?php echo empty($toggle_position) || ( 'right-middle' === $toggle_position) ? esc_attr( 'selected' ) : ''; ?>">
                                    <?php _e( 'Right Middle', 'instantio' ) ?>
                                </option>

                                <option value="right-bottom" selected="<?php echo empty($toggle_position) || ( 'right-bottom' === $toggle_position) ? esc_attr( 'selected' ) : ''; ?>">
                                    <?php _e( 'Right Bottom', 'instantio' ) ?>
                                </option>

                                <option value="left-top" selected="<?php echo empty($toggle_position) || ( 'left-top' === $toggle_position) ? esc_attr( 'selected' ) : ''; ?>">
                                    <?php _e( 'Left Top', 'instantio' ) ?>
                                </option>

                                <option value="left-middle" selected="<?php echo empty($toggle_position) || ( 'left-middle' === $toggle_position) ? esc_attr( 'selected' ) : ''; ?>">
                                    <?php _e( 'Left Middle', 'instantio' ) ?>
                                </option>

                                <option value="left-bottom" selected="<?php echo empty($toggle_position) || ( 'left-bottom' === $toggle_position) ? esc_attr( 'selected' ) : ''; ?>">
		...
		private function tf_setup_step_three() {
            $cart_icon_style = !empty(insopt( 'cart-icon-style' )) ? insopt( 'cart-icon-style' ) : '';
                        ...
                        <div class="tf-setup-form-item middle">
                            ...
                            <div class="tf-setup-form-item-input"> 
                                <select name="ins-layout-animation" id="ins-layout-animation">
                                    ...
                                    <option value="ins_animate_default" selected="<?php echo empty($ins_layout_animation) || ( 'ins_animate_default' === $ins_layout_animation) ? esc_attr( 'selected' ) : ''; ?>">
                                        <?php _e( 'Default Animation', 'instantio' ) ?>
                                    </option>

                                    <option value="ins_animate_one" selected="<?php echo empty($ins_layout_animation) || ( 'ins_animate_one' === $ins_layout_animation) ? esc_attr( 'selected' ) : ''; ?>">
