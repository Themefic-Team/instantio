...
class INS_ENQUEUE {
    public function __construct() {  
        ...
        add_action( 'wp_enqueue_scripts', array($this, 'instantio_enqueue_scripts'), 999 );
        add_action( 'wp_enqueue_scripts', array($this, 'ins_custom_css'), 99999 );
        add_action( 'wp_enqueue_scripts', array($this, 'instantio_custom_js'), 99999 );

    } 

    // Enqueue scripts and styles For Admin.
    public function ins_enqueue_admin_scripts(){
    ...
    public function ins_dequeue_scripts() {
    ...
    public function instantio_enqueue_scripts(){
    ...
    // Custom CSS
    public function ins_custom_css(){
    ...
    // Custom JS
    public function instantio_custom_js(){
