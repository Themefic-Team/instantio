...
CSF::createSection( $prefix, array(
    ...
    'fields' => array(
        ...
        array(
            'type'    => 'content',
            'content' => '<a href="#" data-id="cart" class="admin-scroll button">Cart Section</a> <a href="#" data-id="billing" class="admin-scroll button">Billing Section</a> <a href="#" data-id="review" class="admin-scroll button">Review Section</a> <a href="#" data-id="payment" class="admin-scroll button">Payment Section</a>',
        ),
